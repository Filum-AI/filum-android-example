package ai.filum.filum_android;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                showTextInputDialog(InputType.TYPE_CLASS_TEXT, "User ID", new OnSubmitDialogListener() {
                    ...
                    public void onSubmit(String text) {
                        ...
                        filum.identify(text, new JSONObject());
                        setAuthState(true);
                    }
                });
            }
                ...
                showSignUpDialog(new SignUpDialogFragment.OnSubmitListener() {
                    ...
                    public void onSubmit(String userId, String email) {
                        ...
                        try {
                            ...
                            filum.identify(userId, props);
                            filum.track("User Signed Up", props);
                            setAuthState(true);
                ...
                showTextInputDialog(InputType.TYPE_CLASS_NUMBER, "Economy group", new OnSubmitDialogListener() {
                    ...
                    public void onSubmit(String text) {
                        ...
                        try {
                            ...
                            filum.track("Page Visited", props);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
            ...
            public void onClick(View v) {
                for (int i = 1; i < 31; i++) {
                    try {
                        JSONObject props = new JSONObject();
                        props.put("index", i);
                        filum.track("Test Events Sent ", props);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
                ...
                showTextInputDialog(InputType.TYPE_CLASS_TEXT, "Problem text", new OnSubmitDialogListener() {
                    ...
                    public void onSubmit(String text) {
                        ...
                        try {
                            ...
                            filum.track("Question Asked", props);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
                ...
                showTextInputDialog(InputType.TYPE_CLASS_TEXT, "Full name", new OnSubmitDialogListener() {
                    ...
                    public void onSubmit(String text) {
                        ...
                        try {
                            ...
                            filum.identify("1234567890", props);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
        ...
        increaseButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                filum.increaseProperty("count", 1);
            }
        });
...
//                        filum.appendToProperty("tags", array);
                    }
                });
            }
        });
...
//                        filum.removeFromProperty("tags", array);
                    }
                });
            }
        });
